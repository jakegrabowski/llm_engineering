...
class TestValidateCommand:
    ...
    def test_validate_example_definition(self) -> None:
        ...
        result = runner.invoke(app, ["validate", str(def_path)])
    ...
    def test_validate_json_format(self) -> None:
        ...
        if not def_path.exists():
            ...
            pytest.skip("Example definition not found")
        result = runner.invoke(app, ["validate", str(def_path), "--format", "json"])
        assert result.exit_code == 0
...
class TestValidateDefinition:
    def test_resolves_example(self) -> None:
        ...
        if not def_path.exists():
            ...
            pytest.skip("Example definition not found")
        result = validate_definition(def_path, project_root=ws_root)
